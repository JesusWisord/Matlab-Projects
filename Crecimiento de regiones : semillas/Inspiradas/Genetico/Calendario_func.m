function [fitness_std_numero] = Calendario_func(poblacion, mutacion, cruza, generaciones)
...
for generaciones=1:numeroDeGeneraciones
    ...
    fitness_vector(generaciones)=std(costoSemanal);
...
fitness_std_numero=mean(fitness_vector);
