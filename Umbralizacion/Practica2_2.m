function [ imagen1 ] = untitled( input_args )
...
%   Detailed explanation goes here
    ...
    figure (2), imshow(imagen1/255, 'Colormap', hsv(5))
    saveas(figure (2),'Pseudocolor 1.jpg', 'jpg');
    ...
    for z=1:5;
        ...
        %Mostramos nuestra imagen resultante en un pseudocolor para poder
        %apreciar los 4 colores distintos facilmente
        h=figure (3), imshow(imagen1/255, 'Colormap', hsv(5))
        DATOS='Pseudocolor';
